...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Nov 2021 pada 10.24
...
(1, '-', 'Dinas Pendidikan dan Kebudayaan Provinsi Jawa Tengah ', 'Aktif', 'Jl Pemuda no 1 Semarang Tengah', 'Amron ', '-', 'https://www.pdkjateng.go.id/', 'pdkjateng@pdk.mail.com', '1.JATENG.png', 1);
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Ahmad Amron', '-', 1),
